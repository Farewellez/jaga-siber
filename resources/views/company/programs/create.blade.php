                    ...
                    <form action="{{ route('company.programs.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="block mt-4">
                            <label for="is_public" class="inline-flex items-center">
                                <input id="is_public" type="checkbox" class="rounded border-gray-600 bg-gray-900 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_public" value="1" {{ old('is_public', true) ? 'checked' : '' }}>
